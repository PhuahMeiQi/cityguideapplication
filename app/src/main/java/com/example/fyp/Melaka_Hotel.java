...
public class Melaka_Hotel extends AppCompatActivity
{
    ListView lvHotel;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_melaka__hotel);
        ...
        class LoadHotel extends AsyncTask<Void,Void,String>
        {
            ...
            protected String doInBackground(Void... voids)
            {
                ...
                String s = rh.sendPostRequest
                        ("http://tommyworkspace.com/cityguide/melaka/load_hotel.php",hashMap);
                return s;
            }
            ...
            protected void onPostExecute(String s)
            {
                ...
                ListAdapter adapter = new Custom_Melaka_Hotel(
                        Melaka_Hotel.this, Acclist,
                        R.layout.activity_melaka_hotel_list, new String[]
