...
public class Custom_Penang_Cuisine extends SimpleAdapter
{
    private Context mContext;
    public LayoutInflater inflater=null;

    public Custom_Penang_Cuisine(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            if(convertView==null)
                vi = inflater.inflate(R.layout.activity_penang_cuisine_list, null);
            ...
            TextView tvhalal = vi.findViewById(R.id.textView4);
            ...
            String dhalal = (String)data.get("Halal");
            String did = (String)data.get("Id");

            tvname.setText(dname);
            tvadd.setText("Address: "+dadd);
            tvphone.setText("Phone: "+dphone);
            tvhalal.setText(dhalal);

            String image_url = "http://tommyworkspace.com/cityguide/images/PenangCuisine/"+did+".jpg";
