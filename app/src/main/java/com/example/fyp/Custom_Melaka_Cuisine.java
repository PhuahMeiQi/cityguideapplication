...
public class Custom_Melaka_Cuisine extends SimpleAdapter
{
    private Context mContext;
    public LayoutInflater inflater=null;

    public Custom_Melaka_Cuisine(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            if(convertView==null)
                vi = inflater.inflate(R.layout.activity_melaka_cuisine_list, null);
            ...
            String image_url = "http://tommyworkspace.com/cityguide/images/MelakaCuisine/"+did+".jpg";
