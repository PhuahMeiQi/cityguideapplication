...
public class Custom_Melaka_Popular extends SimpleAdapter
{
    private Context mContext;
    public LayoutInflater inflater=null;

    public Custom_Melaka_Popular(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            if(convertView==null)
                vi = inflater.inflate(R.layout.activity_melaka_pop_list, null);
            ...
            CircleImageView imgrest =vi.findViewById(R.id.imageView3);
            ...
            String image_url = "http://tommyworkspace.com/cityguide/images/MelakaAttractions/"+dname+".jpg";
